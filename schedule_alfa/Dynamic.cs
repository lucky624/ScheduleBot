...
namespace schedule_alfa
{
    class Dynamic
    {
        ...
        public static Thread Updater_Schedule_Changes = new Thread(update_schedule_changes);


        public static void update_schedule_changes()
        {
            Kill();
        ...
        public static void Kill()
        {
            ...
            try
            {
                string batDir = string.Format(@"C:\Users\schedule\Desktop\");
                proc = new Process();
            ...
            try
            {
                foreach (var process in Process.GetProcessesByName("read_xls_stable"))
                {
                    process.Kill();
                }
            }
        ...
        public static void UP()
        {
            try
            {
                Process.Start(@"C:\Users\schedule\Desktop\Stable\Read_xls\Read_xls\bin\Debug\Read_xls.exe");
            }
            catch { }
        }
        ...
        public static string Sheet_name_to_date(string sheet_name)
        {
            ...
            if (have_dot == true)
            {
                ...
                if (day != "error" && month != "error")
                {
                    ...
                    done_date = time.Month + "-" + month + "-" + day + " " + time.Hour + ":" + time.Minute + ":" + time.Second;
